achievements = {
    'BLANK_00': {'bit': 0b1, 'name': '未定義01', 'description': '', 'requirement': ''},
    'BLANK_01': {'bit': 0b1 << 1, 'name': '未定義02', 'description': '', 'requirement': ''},
    'BLANK_02': {'bit': 0b1 << 2, 'name': '未定義03', 'description': '', 'requirement': ''},
    'BLANK_03': {'bit': 0b1 << 3, 'name': '未定義04', 'description': '', 'requirement': ''},
    'BLANK_04': {'bit': 0b1 << 4, 'name': '未定義05', 'description': '', 'requirement': ''},
    'BLANK_05': {'bit': 0b1 << 5, 'name': '未定義06', 'description': '', 'requirement': ''},
    'BLANK_06': {'bit': 0b1 << 6, 'name': '未定義07', 'description': '', 'requirement': ''},
    'BLANK_07': {'bit': 0b1 << 7, 'name': '未定義08', 'description': '', 'requirement': ''},
    'BLANK_08': {'bit': 0b1 << 8, 'name': '未定義09', 'description': '', 'requirement': ''},
    'BLANK_09': {'bit': 0b1 << 9, 'name': '未定義10', 'description': '', 'requirement': ''},
    ...
    'OMIKUJI_ATTENTION_COUNT_1': {'bit': 0b1 << 48, 'name': '慌てないで', 'description': '1日1回だけだから！', 'requirement': 'おみくじで1回注意される'},
    'OMIKUJI_ATTENTION_COUNT_10': {'bit': 0b1 << 49, 'name': '厳重注意', 'description': 'ちゃんと注意は読みましょう', 'requirement': 'おみくじで10回注意される'},
    'OMIKUJI_ATTENTION_COUNT_20': {'bit': 0b1 << 50, 'name': '話を聞いて', 'description': 'お願いだから話を聞いてほしい', 'requirement': 'おみくじで20回注意される'},
    'OMIKUJI_ATTENTION_COUNT_30': {'bit': 0b1 << 51, 'name': '常習犯', 'description': '君はきっと寂しいだけなんだね', 'requirement': 'おみくじで30回注意される'},
    'OMIKUJI_ATTENTION_COUNT_40': {'bit': 0b1 << 52, 'name': '確信犯', 'description': 'わざとだよね？え？わざとだよね？', 'requirement': 'おみくじで40回注意される'},
    'OMIKUJI_ATTENTION_COUNT_50': {'bit': 0b1 << 53, 'name': '神聖かまってちゃん', 'description': 'そんなにかまってほしいか！！', 'requirement': 'おみくじで50回注意される'},
}
